                        ...
                        <table id="table_desafios">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center; background-color: black; color:aliceblue">JUGADOR</th>
                                    <th style="text-align: center; background-color: black; color:aliceblue">JUGADOS</th>
                                    <th style="text-align: center; background-color: black; color:aliceblue">GANADOS</th>
                                    <th style="text-align: center; background-color: black; color:aliceblue">ULTIMO JUGADO
                                    </th>
                                    <!-- <th>ESTADO</th> -->
